...
import com.gabloz.iaccountant.entity.CuentaUsuario;
import com.gabloz.iaccountant.entity.Movimiento;
import com.gabloz.iaccountant.entity.Operacion;
...
public class MovimientoDatastore {
	...
	public Object[] getGastos(Movimiento movimiento, String cursorWebSafe) {
		...
		q.setFilter( Query.FilterOperator.EQUAL.of("nicknameUsr", movimiento.getNicknameUsr() ));
